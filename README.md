<p align="center">
  <img src="assets/apple-hero.svg" alt="MessageShield messaging trust and safety hero" width="100%" />
</p>
...
`Python` · `scikit-learn` · `NetworkX` · `Streamlit` · `NLP` · `Graph Analytics` · `Causal Inference`
...
## A clearer view of messaging risk.
...
|---|---|
| **Detect** | Is this message likely to be harmful or unwanted? |
| **Understand** | What abuse pattern, sender behavior, or campaign context explains the risk? |
| **Protect** | What is the least disruptive action that still reduces harm? |
| **Measure** | Did the intervention improve user safety without excessive false positives? |
| **Adapt** | Is the ecosystem changing in a way that requires model or policy updates? |
...
1. `dashboard/app.py` — **Trust & Safety Command Center**
2. `dashboard/pages/1_Model_Performance.py` — **Model Performance**
3. `dashboard/pages/2_Abuse_Network.py` — **Abuse Network & Sender Behavior**
...
8. `dashboard/pages/7_Campaign_Graph.py` — **Coordinated Campaign Detection**
